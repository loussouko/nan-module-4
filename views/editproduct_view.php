                    ...
                    <form action="editproduct" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control shadow" name="nom" id="nom" placeholder="votre nom" value="<?= $produits['nomProduit'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat" class="col-form-label h5 col-sm-12 text-center" >Categorie au paravant: <?php $cat=Category::getNomCategory($produits['idCategorie']); echo $cat['nomCategorie']; ?> </label>
                            ...
                            <div class="form-group">
                                <label for="stock" class="col-form-label h5 col-sm-12 text-center" >Stock au paravant: <?= $produits['stockProduit'] ?></label>
                            ...
                            <div class="form-group">
                                <label for="img" class="col-form-label h5 col-sm-12 text-center">Image du produit:<img src="<?= $produits['imageProduit'] ?>" height="80"/></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control shadow" name="prix" id="prix" placeholder="prix du produit" value="<?= $produits['prixProduit'] ?>">
                            </div>
                        </fieldset>
                        <fieldset>
                            <legend class="text-center text-primary">Details</legend>
                            <div class="form-group">
                                <textarea name="cont" class= "form-control shadow" id="cont" rows="20"><?= $produits['detailProduit'] ?></textarea>
                            </div>
                            <div class="form-group">
